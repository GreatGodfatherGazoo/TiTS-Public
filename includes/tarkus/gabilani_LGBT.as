...
public function revengeForTheRevengeGod():void
{
	...
	output("\n\n<i>“Great, isn’t it?”</i> sighs the " + (!maleBitch ? "female":"male") + ", leaning into you to watch " + (!maleBitch ? "her":"his") + " flailing, juddering partner on the screen. <i>“Once you see the stuff in action, it becomes a shame NOT to use it, don’t you think?”</i>");
